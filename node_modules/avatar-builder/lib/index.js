...
const core_avatar_1 = require("./internal/core-avatar");
...
(function (Avatar) {
    ...
    function builder(imageBuilder, width, height, options) {
        return new core_avatar_1.AvatarBuilder(imageBuilder, width, height, options);
    }
    ...
    function catBuilder(size = 256, options) {
        return new core_avatar_1.AvatarBuilder(Image.cat(), size, size, options);
    }
    ...
    function githubBuilder(size = 256, precision = 3, options) {
        return new core_avatar_1.AvatarBuilder(Image.github(precision), size, size, options);
    }
     ...
     * @param options builder options (cache,...)
     */
    function triangleBuilder(size = 256, precision = 4, colors = core_avatar_1.DEFAULT_COLORS, options) {
        return new core_avatar_1.AvatarBuilder(Image.triangle(precision, colors), size, size, options);
    }
    ...
    function identiconBuilder(size = 256, options) {
        return new core_avatar_1.AvatarBuilder(Image.identicon(), size, size, options);
    }
     ...
     * @param options builder options (cache,...)
     */
    function squareBuilder(size = 256, precision = 3, colors = core_avatar_1.DEFAULT_COLORS, options) {
        return new core_avatar_1.AvatarBuilder(Image.square(precision, colors), size, size, options);
    }
    ...
    function female8bitBuilder(size = 256, options) {
        return new core_avatar_1.AvatarBuilder(new eight_bit_avatar_1.FemaleEightBitImageBuilder(), size, size, options);
    }
    ...
    function male8bitBuilder(size = 256, options) {
        return new core_avatar_1.AvatarBuilder(new eight_bit_avatar_1.MaleEightBitImageBuilder(), size, size, options);
    }
    ...
    (function (Image) {
        ...
        function roundedRectMask(imageBuilder, radius = 10) {
            return new core_avatar_1.RoundedRectMaskImageBuilder(imageBuilder, radius);
        }
         ...
         */
        function shadow(imageBuilder, shadow = { blur: 10, color: '#000000', offsetX: 0, offsetY: 0 }) {
         ...
         */
        function scoreShadow(imageBuilder, shadowColor = { red: 0, green: 0, blue: 0, alpha: 24 }) {
            return new core_avatar_1.ScoreShadowImageBuilder(imageBuilder, shadowColor);
        }
         ...
         * @param shadowColor shadow color
         */
        function longShadow(imageBuilder, shadowColor = { red: 0, green: 0, blue: 0, alpha: 64 }) {
            return new core_avatar_1.LongShadowImageBuilder(imageBuilder, shadowColor);
        }
         ...
         */
        function identicon(patchSize = 20, backgroundColor = { red: 255, green: 255, blue: 255 }) {
            return new identicon_avatar_1.IdenticonImageBuilder(patchSize, backgroundColor);
        }
         ...
         * @param colors list of colors
         */
        function triangle(precision = 4, colors = core_avatar_1.DEFAULT_COLORS) {
            return new triangle_avatar_1.TriangleImageBuilder(precision, colors);
        }
        ...
        function grid(imageBuilder, gridx, gridy) {
            return new core_avatar_1.GridImageBuilder(imageBuilder, gridx, gridy);
        }
        Image.grid = grid;
